...
export const ReferralProgress: React.FC<ReferralProgressProps> = ({
  ...
  return (
    <Card className={cn("bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700", className)}>
      <CardContent className="pt-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <p className={cn(
              "text-2xl font-bold",
              isComplete ? "text-green-400" : "text-green-500"
            )}>
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-slate-500 dark:text-slate-400">Referral Progress</span>
            <span className="text-green-500 font-medium">{referralCount}/{targetCount}</span>
          </div>
          <Progress
              ...
              <div
                className={cn(
                  ...
                  referralCount >= step
                    ...
                    : "bg-slate-950 text-slate-500 dark:text-slate-400 border border-green-500/30"
                )}
              >
        ...
        {!isComplete && (
          <div className="mt-4 p-3 rounded-md bg-green-500/10 border border-green-500/20">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Earn <span className="text-green-500 font-semibold">+10%</span> more on every payment when you reach 3 referrals
              </p>
            </div>
          </div>
        )}
