...
const EmailTest = () => {
  const [testData, setTestData] = useState({
    ...
    recipientEmail: 'your-test-email@example.com', // Change this to your email
  });
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-yellow-700 space-y-1">
                <li>• Make sure to set your real email address in "Recipient Email"</li>
                <li>• Check that RESEND_API_KEY is configured in Supabase Edge Functions</li>
                <li>• Check spam folder if you don't see the email</li>
                <li>• This will send a real email using the production template</li>
              </ul>
            </div>
